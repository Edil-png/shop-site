...
import { 
  ...
  Cpu, Gamepad2, Smartphone, Headphones,
  Search, X
} from 'lucide-react'
...
const categories = [
  ...
  { id: 'gaming', name: 'Гейминг', icon: <Gamepad2 className="h-4 w-4" />, color: 'text-orange-400' },
  { id: 'creative', name: 'Творчество', icon: <Cpu className="h-4 w-4" />, color: 'text-purple-400' },
  { id: 'mobile', name: 'Мобильность', icon: <Smartphone className="h-4 w-4" />, color: 'text-blue-400' },
  { id: 'accessory', name: 'Аксессуары', icon: <Headphones className="h-4 w-4" />, color: 'text-green-400' }
]
  ...
  return (
    <div className="min-h-screen py-20">
      <div className="container mx-auto px-4">
        {/* Заголовок и поиск */}
        <div className="mb-8">
          <h1 className="font-exo text-4xl font-bold mb-2">Каталог устройств</h1>
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {selectedPrice !== 'all' && (
                    <span className="inline-flex items-center gap-1 px-3 py-1 bg-blue-500/20 text-blue-400 rounded-full text-sm">
                      ...
                      <button onClick={() => setSelectedPrice('all')} className="ml-1 hover:text-white">
                        <X className="h-3 w-3" />
                      </button>
                    </span>
                  )}
            ...
            <div className="glass-card rounded-xl p-6 sticky top-24">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-3">
                  {[
                    { id: 'gaming', name: 'Nexus Gaming', color: 'border-orange-500' },
                    { id: 'creative', name: 'Nexus Creator', color: 'border-purple-500' },
                    { id: 'mobile', name: 'Nexus Mobile', color: 'border-blue-500' }
                  ].map((eco) => (
                    <label key={eco.id} className="flex items-center cursor-pointer group">
                      <input
                        type="checkbox"
              ...
              <div>
                ...
                <div className="space-y-3">
                  {['Nexus', 'ASUS', 'Apple', 'Logitech', 'Samsung'].map((brand) => (
            ...
            {filteredProducts.length === 0 ? (
              <div className="text-center py-20">
                ...
                <p className="text-gray-400 mb-6 max-w-md mx-auto">
                  Попробуйте изменить параметры фильтрации или ввести другой поисковый запрос
                </p>
                <button
                  onClick={clearFilters}
              ...
              <>
                <div className={viewMode === 'grid' 
                  ...
                  {filteredProducts.map((product) => (
                    <div key={product.id} className={viewMode === 'list' ? 'glass-card rounded-xl' : ''}>
                ...
                <div className="mt-12 flex justify-center">
                  <nav className="flex items-center gap-2">
                    <button className="px-4 py-2 border border-gray-700 hover:border-gray-600 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed" disabled>
                      Назад
                    </button>
                    <button className="px-4 py-2 bg-blue-600 text-white rounded-lg">1</button>
                    <button className="px-4 py-2 border border-gray-700 hover:border-gray-600 rounded-lg transition-colors">2</button>
                    <button className="px-4 py-2 border border-gray-700 hover:border-gray-600 rounded-lg transition-colors">3</button>
                    <span className="px-2 text-gray-500">...</span>
                    <button className="px-4 py-2 border border-gray-700 hover:border-gray-600 rounded-lg transition-colors">10</button>
        ...
        <div className="mt-16 glass-card rounded-2xl p-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">Все платежи защищены шифрованием</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">Расширенная гарантия на все устройства</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">Доставка по России за 1-3 дня</p>
            </div>
          </div>
        </div>
      </div>
